...
6. **Mappa & Clustering Posizioni**: Mappatura dei punti GPS con distinzione tra consumo a *Casa* e *Fuori Casa*, con possibilità di **rinominare i luoghi** (es. *Ufficio, Bar, Palestra*) sincronizzandoli automaticamente con **Google Sheets** su tutti i tuoi dispositivi.
